...
config.misc.CSFD.Resolution = ConfigSelection(choices=[('0', _('automaticky')), ('720', _('720')), ('1280', _('1280')), ('1920', _('1920')), ('2560', _('2560'))], default='0')
...
config.misc.CSFD.ShowLowPriorityResults = ConfigYesNo(default=False)
config.misc.CSFD.SetTvStations = ConfigYesNo(default=True)
...
config.misc.CSFD.VideoResolution = ConfigSelection(choices=[('360', '360p'), ('480', '480p'), ('720', '720p'), ('1080', '1080p'), ('1440', '1440p')], default='1080')
...
def ResetParams():
	...
	config.misc.CSFD.ShowLowPriorityResults.saved_value = None
	config.misc.CSFD.SetTvStations.saved_value = None
	...
	config.misc.CSFD.ShowLowPriorityResults.load()
	config.misc.CSFD.SetTvStations.load()
...
def InitParamsLangImpact():
	...
	config.misc.CSFD.Language = ConfigSelection(choices=[('0', _('automaticky')), ('1', _('česky')), ('2', _('slovensky'))], default='0')
	config.misc.CSFD.Resolution = ConfigSelection(choices=[('0', _('automaticky')), ('720', _('720')), ('1280', _('1280')), ('1920', _('1920')), ('2560', _('2560'))], default='0')
	config.misc.CSFD.QualityPoster = ConfigSelection(choices=[('h180', '180p'), ('h360', '360p'), ('h480', '480p'), ('h720', '720p'), ('h1080', '1080p'), ('h1440', '1440p'), _('Maximální') ], default='h720')
	config.misc.CSFD.QualityGallery = ConfigSelection(choices=[('h180', '180p'), ('h360', '360p'), ('h480', '480p'), ('h720', '720p'), ('h1080', '1080p'), ('h1440', '1440p'), _('Maximální') ], default='h720')
	config.misc.CSFD.QualityVideoPoster = ConfigSelection(choices=[('h180', '180p'), ('h360', '360p'), ('h480', '480p'), ('h720', '720p'), ('h1080', '1080p'), ('h1440', '1440p'), _('Maximální') ], default='h720')
	...
	config.misc.CSFD.FontHeightWQHD = ConfigSelection(choices=[('32', '32'), ('33', '33'), ('35', '35'), ('36', '36'), ('37', '37'), ('39', '39'), ('40', '40'), ('41', '41'), ('43', '43'), ('44', '44'), ('45', '45'), ('47', '47'), ('48', '48'), ('49', '49'), ('51', '51'), ('52', '52'), ('53', '53'), ('55', '55'), ('56', '56'), ('57', '57'), ('59', '59'), ('60', '60'), ('61', '61'), ('63', '63'), ('64', '64'), ('65', '65'), ('67', '67'), ('68', '68'), ('69', '69'), ('71', '71'), ('72', '72'), ('73', '73'), ('75', '75')], default='37')
